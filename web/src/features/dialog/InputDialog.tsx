  ...
  return (
    <>
      <Modal
        ...
        size="xs"
        styles={{ title: { textAlign: 'center', width: '100%', fontSize: 20, textTransform: 'uppercase', color: 'white' } }}
        ...
        <form onSubmit={onSubmit}>
          <Stack>
            ...
            <Group position="right" spacing={10}>
              ...
              <Button uppercase variant="default" type="submit" style={{background:'rgba(3, 117, 255,0.5)'}}>
                {locale.ui.confirm}
              </Button>
            </Group>
          </Stack>
