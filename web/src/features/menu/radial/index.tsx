...
const useStyles = createStyles((theme) => ({
  ...
  sector: {
    ...
    cursor: 'pointer',
    '&:hover': {
      fill: 'url(#sector-hover-gradient)',
      filter: 'drop-shadow(0px 0px 50px 0px rgb(3, 13, 25))',
      transition: 'all 0.3s ease',      
      '> g > text': {
        fill: '#fff',
      },
          ...
          >
            <defs>
              <radialGradient id="bg-gradient" cx="50%" cy="50%" r="50%">
                 <stop offset="0%" stopColor="#0b0e2425" />
                 <stop offset="100%" stopColor="#060b1a" />
               </radialGradient>
               <linearGradient id="sector-gradient" x1="0" y1="0" x2="1" y2="1">
                 <stop offset="0%" stopColor="rgba(255, 255, 255, 0.1)" />
                 <stop offset="100%" stopColor="rgba(255, 255, 255, 0.1)" />
               </linearGradient>
               <linearGradient id="sector-hover-gradient" x1="0" y1="0" x2="1" y2="1">
                 <stop offset="0%" stopColor="rgba(3, 13, 25, 0.2)" />
                 <stop offset="100%" stopColor="rgba(3, 13, 25, 0.2)" />
               </linearGradient>
           </defs>
